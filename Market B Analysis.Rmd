...
Dado los objetivos de minería planteados en el anteproyecto, se requiere un soporte mínimo del 1% (creo que necesitamos cambiar este porcentaje), y un mínimo de confianza del 0.85
...
## 5 mejores reglas según la confianza usando ECLAT
...
## 5 mejores reglas según la confianza usando Apriori
...
Reglas de asociación generadas por modelo: 181032 para el apriori, y 278689 para el ECLAT. 

Agregar tiempos variando el valor inicial de soporte
...
** De acuerdo al analisis de Apriori o Eclat los primeros 10 Itemsets son los que tiene un soporte mayor al 1% y una confianza mayor al 0.85. Los cuales se puede utilizar para definir una estrategia de venta mas eficiente.
